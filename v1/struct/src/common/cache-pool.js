/**
* @Author: fiyc
* @Date : 2018-11-08 14:59
* @FileName : cache-pool.js
* @Description : 
    - 缓存模块
*/
...
let pushCache = function(levels, key, object){
    ...
    let objectJsonStr = JSON.stringify(object);
    let ObjectValue = JSON.parse(objectJsonStr);

    currentCache[key] = ObjectValue;
}
